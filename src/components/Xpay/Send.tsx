...
function Send() {
  ...
  const approveButtonNeeded = isEVMChain(sourceChain) && !sufficientAllowance && sourceAsset;
  ...
  return (
    <>
      ...
      <Alert severity="info" variant="outlined">
        Click below to initiate the transfer on {CHAINS_BY_ID[sourceChain].name} and
